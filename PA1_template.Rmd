...
```{r, echo=TRUE}
#
stepDayTypeImputed2 <- aggregate(x=activityImputed$steps, by=list(activityImputed$interval,activityImputed$dayType), data=activityImputed, FUN=mean)
#group the activity table by day type and interval
